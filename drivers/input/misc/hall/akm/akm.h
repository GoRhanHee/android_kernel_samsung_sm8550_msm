...
#define AKM_AK09973D	0
#define AKM_AK09973DW	1

#define AKM_SPEC_NUMBER				6 /* minX, maxX, minY, maxY, minZ, maxZ */
int selftest_spec_table[2][AKM_SPEC_NUMBER] = {
	{ -120, 120, -120, 120, 60, 400 }, /* AK09973D */
	{ -45, 45, -45, 45, 20, 150 } /* AK09973DW */
};
