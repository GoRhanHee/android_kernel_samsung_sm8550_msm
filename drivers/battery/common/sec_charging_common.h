...
#if IS_ENABLED(CONFIG_SEC_Q5Q_PROJECT) || IS_ENABLED(CONFIG_SEC_B5Q_PROJECT) || \
	IS_ENABLED(CONFIG_SEC_UNIVERSAL_PROJECT)
...
#if IS_ENABLED(CONFIG_SEC_Q5Q_PROJECT) || IS_ENABLED(CONFIG_SEC_UNIVERSAL_PROJECT)
enum mfc_phm_state {
	NONE_PHM = 0,
	EXIT_PHM,
	ENTER_PHM,
